...
async function main() {
  ...
  await Promise.all([
    prisma.usuario.upsert({
      ...
      update: {},
      create: { email: 'gabriela.munoz@colegio.cl', passwordHash: PASSWORD_HASH, rol: RolSistema.ENCARGADO_CONVIVENCIA, funcionarioId: gabriela.id },
    }),
    prisma.usuario.upsert({
      where: { email: 'carlos.martinez@colegio.cl' },
      update: {},
      create: { email: 'carlos.martinez@colegio.cl', passwordHash: PASSWORD_HASH, rol: RolSistema.DOCENTE, funcionarioId: carlos.id },
    }),
    prisma.usuario.upsert({
      where: { email: 'beatriz.rojas@colegio.cl' },
      update: {},
      create: { email: 'beatriz.rojas@colegio.cl', passwordHash: PASSWORD_HASH, rol: RolSistema.INSPECTOR, funcionarioId: beatriz.id },
    }),
    prisma.usuario.upsert({
      where: { email: 'diego.herrera@colegio.cl' },
      update: {},
      create: { email: 'diego.herrera@colegio.cl', passwordHash: PASSWORD_HASH, rol: RolSistema.ORIENTADOR, funcionarioId: diego.id },
    }),
    prisma.usuario.upsert({
      where: { email: 'elena.castro@colegio.cl' },
      update: {},
      create: { email: 'elena.castro@colegio.cl', passwordHash: PASSWORD_HASH, rol: RolSistema.EQUIPO_DIRECTIVO, funcionarioId: elena.id },
    }),
    prisma.usuario.upsert({
      where: { email: 'admin@colegio.cl' },
      update: {},
      create: { email: 'admin@colegio.cl', passwordHash: PASSWORD_HASH, rol: RolSistema.ADMINISTRADOR, funcionarioId: roberto.id },
    }),
  ])
